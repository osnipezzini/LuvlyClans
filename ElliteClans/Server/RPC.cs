        ...
        public static void RPC_RequestClans(long sender, ZPackage pkg)
        {
            ...
            if (pkg != null && pkg.Size() > 0)
            {
                ...
                if (peer != null)
                {
                    ...
                    Clan peerClan = ClansHelper.GetClanByPlayerName(peerPlayerName, false);
                    Member peerMember = ClansHelper.GetClanMemberFromClanByPlayerName(peerClan, peerPlayerName);
                    ...
                    else
                    {
                        ...
                        ClansHelper.CreateWildling(peerPlayerName, peerPlayerID);
