...
namespace ElliteClans
{
    ...
    {
        internal static bool m_has_clans_server = Startup.ClansServer != null && Startup.ClansServer.m_clans.Length > 0;
        internal static bool m_has_clans_client = Startup.ClansClient != null && Startup.ClansClient.m_clans.Length > 0;
        ...
        {
            Clans clans = isClient ? ElliteClans.Startup.ClansClient : ElliteClans.Startup.ClansServer;
        ...
        {
            Clans clans = isClient ? Startup.ClansClient : Startup.ClansServer;
            bool hasClans = isClient ? m_has_clans_client : m_has_clans_server;
        ...
        public static void CreateWildling(string playerName, long playerID)
        {
            ...
            if (wildlings == null)
            {
                ...
                AddClan(Startup.ClansServer, newWildlings);
            } else
            {
